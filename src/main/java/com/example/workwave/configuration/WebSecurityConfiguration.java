    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable()
                ...
                "/refresh","/PartenaireC/retrieve-partenaire/{Partenaire-id}","/PartenaireC/addPartenaire","/PartenaireC/updatePartenaire","/PartenaireC/deletePartenaire/{partenaire-id}" ,
                        ...
                        "/Contrat","/ContratById/{id}","/addContrat","/updateContrat","/deleteContrat/{id}" , "/project", "/project/{id}","/addProject","/updateProject/{id}","/deleteProject/{id}","/task","/Task/{id}","/addTask","/updateTask","/deleteTask/{id}","/ScrumBoard","/ScrumBoard/{id}","/addScrumBoard","/updateScrumBoard","/deleteScrumBoard/{id}").permitAll()
