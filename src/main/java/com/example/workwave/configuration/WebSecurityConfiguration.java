    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable()
                ...
                "/refresh","/PartenaireC/retrieve-partenaire/{Partenaire-id}","/PartenaireC/addPartenaire","/PartenaireC/updatePartenaire","/PartenaireC/deletePartenaire/{partenaire-id}" ,
                        ...
                        "/Contrat","/ContratById/{id}","/addContrat","/updateContrat","/deleteContrat/{id}","/messages/{senderId}/{recipientId}/count","/messages/{senderId}/{recipientId}","/messages/{id}","/chat","/ws","/user/{userId}/queue/messages","/app/chat","/ws/chat","/user","/chat/add","/","/event","/**").permitAll()
