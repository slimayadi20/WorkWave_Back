...
public class productsController {
    ...
    public String addproducts(@RequestBody products products ) throws IOException, InterruptedException {
        String productName = products.getName();
        String[] command = {"C:/Users/User/AppData/Local/Programs/Python/Python310/python.exe", "C:/Users/User/Desktop/script.py", productName };
